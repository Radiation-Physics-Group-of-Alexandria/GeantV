...
//if you change this, also change it in ClicDetectorConstruction.h and ClicAppData.h
...
/**
 * @brief GeantV implementation of the Geant4 SimplyClic application.
 *
...
//
/** @brief ClicApp user application */
class ClicApp : public Geant::GeantVApplication {
public:

  /** @brief Constructor ClicApp */
  ClicApp(Geant::GeantRunManager *runmgr, ClicDetectorConstruction *det, ClicPrimaryGenerator *gun);

  /** @brief Destructor ClicApp */
  virtual ~ClicApp();
...
private:
  /** @brief Copy constructor ClicApp (deleted) */
  ClicApp(const ClicApp &) = delete;
  /** @brief Operator= for ClicApp (deleted) */
  ClicApp &operator=(const ClicApp &) = delete;
