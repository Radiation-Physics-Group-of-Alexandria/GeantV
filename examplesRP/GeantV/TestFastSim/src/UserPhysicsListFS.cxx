...
#include "StepMaxProcessFS.h"

namespace userfsapplication {


UserPhysicsListFS::UserPhysicsListFS(const std::string &name) : geantphysics::PhysicsList(name) {
...
UserPhysicsListFS::~UserPhysicsListFS() {}

void UserPhysicsListFS::Initialize() {
...
void  UserPhysicsListFS::SetMSCStepLimit(geantphysics::MSCSteppingAlgorithm stepping) {
  fMSCSteppingAlgorithm = stepping;
}

void  UserPhysicsListFS::SetStepMaxValue(double val) { fStepMaxValue = val; }
