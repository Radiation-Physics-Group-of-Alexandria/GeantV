...
UserDetectorConstructionFS::UserDetectorConstructionFS(Geant::GeantRunManager *runmgr) : Geant::GeantVDetectorConstruction(runmgr) {
...
UserDetectorConstructionFS::~UserDetectorConstructionFS() {/* nothing to do */}
...
void UserDetectorConstructionFS::CreateMaterials() {
...
void UserDetectorConstructionFS::ComputeSetup() {
  fTargetMaterial  = geantphysics::Material::NISTMaterial(fTargetMatName);
  fTargetYZ       *= 0.5;
  fTargetX        *= 0.5;
  fWorldYZ         = 1.2*fTargetYZ;
...
void UserDetectorConstructionFS::CreateGeometry() {
...
//  return;
  ...
  // set target logical colume ID and target region index (TestFastSim application will require it)
