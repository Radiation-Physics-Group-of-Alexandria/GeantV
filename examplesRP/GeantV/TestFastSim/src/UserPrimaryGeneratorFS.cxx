...
UserPrimaryGeneratorFS::UserPrimaryGeneratorFS(const UserDetectorConstructionFS *det) : fDetector(det) {
...
UserPrimaryGeneratorFS::~UserPrimaryGeneratorFS() {}


void UserPrimaryGeneratorFS::InitPrimaryGenerator() {
  fParticle            = geantphysics::Particle::GetParticleByName(fPrimaryParticleName);
  if (!fParticle) {
    std::cerr<< "   \n *** ERROR::UserPrimaryGeneratorFS::InitPrimaryGenerator()    \n"
...
Geant::GeantEventInfo UserPrimaryGeneratorFS::NextEvent() {
...
void UserPrimaryGeneratorFS::GetTrack(int /*n*/, Geant::GeantTrack &gtrack) {
  gtrack.SetPDG(fPDG);
