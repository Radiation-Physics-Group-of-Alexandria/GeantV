...
#ifndef FS_USERDETECTORCONSTRUCTION_H
#define FS_USERDETECTORCONSTRUCTION_H
...
/**
 * @brief User detector construction for TeatFastSim.
 *
...
class UserDetectorConstructionFS : public Geant::GeantVDetectorConstruction {
public:
  // CTR
  UserDetectorConstructionFS(Geant::GeantRunManager *runmgr);
  // DTR
 ~UserDetectorConstructionFS();
