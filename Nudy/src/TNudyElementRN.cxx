...
int TNudyElementRN::fCCodeColor[26][3] = {
    {50, 101, 200},  {50, 122, 200},  {50, 144, 200},  {50, 165, 200},  {50, 187, 200},  {50, 208, 200},
    {50, 200, 200},  {61, 200, 179},  {72, 200, 158},  {84, 200, 136},  {95, 200, 115},  {107, 200, 93},
    {118, 200, 72},  {220, 220, 1},   {220, 206, 15},  {220, 178, 43},  {220, 163, 58},  {220, 149, 72},
    {220, 135, 86},  {220, 180, 120}, {220, 166, 134}, {220, 152, 148}, {220, 138, 162}, {220, 123, 177},
    {220, 109, 191}, {220, 95, 205}};
...
Color_t TNudyElementRN::GetColor(double halfLife)
{
  ...
  for (index = 0; fCCodeRange[index] > halfLife && index < fCoSize; index++)
    ;
  if (halfLife <= 0) return TColor::GetColor(0, 0, 0);
