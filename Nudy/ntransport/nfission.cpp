...
int main(){
   ...
   //fout1.open("../../FissionFragments/Pu241_nsEnergyAngle.txt",ios::out);
   //fout2.open("../../FissionFragments/Pu241_FFsmasscharge.txt",ios::out);
   ielemId = 0 ;
...
//     nProcFis->nFissionXsec(nuEn, elementProp);
    	 ...
    	 for(unsigned int ie=0; ie<neutronEnergy.size(); ie++){ //secondary products energy-angle loop
