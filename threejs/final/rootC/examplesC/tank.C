...
//Top which will have the gun
   ...
   top->AddNodeOverlap(mgg1,1,new TGeoCombiTrans(0,0,0,new TGeoRotation("mgg",90,90,0)));
   top->AddNodeOverlap(mgg,1,new TGeoCombiTrans(0,0,0,new TGeoRotation("mgg",0,90,90)));
