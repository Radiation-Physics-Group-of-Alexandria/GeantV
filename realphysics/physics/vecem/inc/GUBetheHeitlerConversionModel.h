#ifndef GUBETHEHEITLERCONVERSIONMODEL_H
#define GUBETHEHEITLERCONVERSIONMODEL_H
...
// data members
private:
  vecphys::ConversionBetheHeitler *fVectorModel;
...
#endif // GUBetheHeitlerConversionModel
