 ...
 * @date    December 2016
 *
 * PhotoElectric model for gamma based on SauterGavrila Model numerical differential cross sections
 * \cite
 */
...
//@{
   /**
    * @brief Constructor to build a model based on the numerical differential cross sections calculated with the SauterGavrila PhotoElectric Model.
    *
...
//@}
  ...
  void Initialise();
    ...
    /**
     * @brief Public method to calculate the SauterGavrilaPhotoElectric differential cross section
     *
...
private:
   ...
   *         the p.d.f.</em>.
   *
   *  This method is used by SauterGavrilaPhotoElectricModel::InitSamplingTables() to build emitted photon energy related
   ...
   *  Number of grid points will be SauterGavrilaPhotoElectricModel::LinAlias::fNumdata which is always the maximum i.e.
   *  SauterGavrilaPhotoElectricModel::fNumSamplingElectronEnergies .
   */
...
double **fLoadDCSForElements;              // container to store DCS data for the used elements
 ...
 double *fSamplingGammaEnergies;   // the common gamma energy grid which we build sampling tables above
   ...
   *
   *        Size of the array is SauterGavrilaPhotoElectricModel::fNumSamplingGammaEnergies points in the
   *        [ln(SauterGavrilaPhotoElectricModel::fMinGammaEnergy), ln(SauterGavrilaPhotoElectricModel::fMaxGammaEnergy)] interval.
   */
