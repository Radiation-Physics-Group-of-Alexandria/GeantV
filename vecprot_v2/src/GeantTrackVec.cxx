...
void GeantTrack_v::GetTrack(int i, GeantTrack &track) const {
  ...
  track.fEvent = fEventV[i];
  track.fEvslot = fEvslotV[i];
  track.fParticle = fParticleV[i];
  track.fMother = fMotherV[i];
  track.fPDG = fPDGV[i];
  ...
  track.fSpecies = fSpeciesV[i];
  track.fStatus = fStatusV[i];
  track.fMass = fMassV[i];
