...
GeantTaskData::GeantTaskData(size_t nthreads, int maxDepth, int maxPerBasket)
    : fTid(-1), fNthreads(nthreads), fMaxDepth(0), fSizeBool(0), fSizeDbl(0), fToClean(false), 
      ...
      fFieldObj(nullptr), fSizeInt(5 * maxPerBasket), fIntArray(new int[fSizeInt]), fFieldPropagator(nullptr), fTransported(nullptr), fTransported1(maxPerBasket), fNkeepvol(0),
