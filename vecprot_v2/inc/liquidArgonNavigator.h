...
class liquidArgonNavigator : public VNavigatorHelper<liquidArgonNavigator,1> {
private:
...
public:
static constexpr const char *gClassNameString="liquidArgonNavigator";
typedef SimpleSafetyEstimator SafetyEstimator_t;

static VNavigator *Instance(){
static liquidArgonNavigator instance;
return &instance;}
...
constexpr double liquidArgonNavigator::globalTranstrans0[];
constexpr double liquidArgonNavigator::globalTransrot0;
constexpr double liquidArgonNavigator::globalTransrot4;
constexpr double liquidArgonNavigator::globalTransrot8;
constexpr short liquidArgonNavigator::deltamatrixmapping[10][4];
constexpr double liquidArgonNavigator::gDeltaTrans0[12];
constexpr double liquidArgonNavigator::gDeltaRot0[12];
constexpr double liquidArgonNavigator::gDeltaRot4[12];
constexpr double liquidArgonNavigator::gDeltaRot8[12];
